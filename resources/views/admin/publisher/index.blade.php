                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control" :value="data.name"
                                                placeholder="Enter name" required minlength="5" maxlength="30">
                                            <label>Email</label>
                                            <input type="email" name="email" class="form-control" :value="data.email"
                                                placeholder="Enter email" required>
                                            <label>Phone Number</label>
                                            <input type="tel" name="phone_number" class="form-control"
                                                :value="data.phone_number" placeholder="Enter number" required>
                                            <label>Address</label>
                                            <input type="textarea" name="address" class="form-control"
                                                :value="data.address" placeholder="Enter address" required>
                                        </div>
                                    </div>
                                </div>
